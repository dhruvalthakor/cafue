...
function Mean() {
  return (
    <>
      <div className="container d-flex justify-content-center flex-column align-items-center" style={{ paddingTop:105,paddingBottom:105,backgroundImage:'url("src/assets/bg.jpg")'}}>
...
<div className="tab-content mt-3" id="pills-tabContent">
  ...
  <Card img="src/assets/pizza.png" title="Margherita Pizza" price="233  "/>
    <Card img="src/assets/chicken.png" title="Chicken Alfredo" price="233  "/>
    <Card img="src/assets/barger.png" title="Caesar Salad" price="233  "/>
    <Card img="src/assets/Coleslaw.png" title="Coleslaw" price="233  "/>
    <Card img="src/assets/chocolate.png" title="Chocolate Brownie" price="233"/>
    <Card img="src/assets/stir-fry.png" title="Vegetable Stir-Fry" price="233 " />
  </div>
  </div>
